...
for(const text of ['dir="rtl"','نظام حجوزات الشاليهات','get_shared_workspace','save_shared_workspace','يوجد حجز مؤكد يتعارض زمنيًا مع هذا الحجز في نفس الشاليه.','navigator.share','backup_before_cloud_push_','lastCloudCounts','lastCloudUpdatedAt','البيانات غير كافية لحكم دقيق.','رفع التعديلات']){if(!html.includes(text))throw new Error(`index.html missing ${text}`);}
